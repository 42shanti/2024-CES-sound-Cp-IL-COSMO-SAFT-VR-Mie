...
# full_file_path_msound = ["C:/Users/clsobe/My Drive/usp-brainstorm/bs04/csv/sound/mix_msound.csv"]
# full_file_path_T = ["C:/Users/clsobe/My Drive/usp-brainstorm/bs04/csv/sound/mix_T.csv"]
...
exp_data = 11 # number of experimental procedures evaluated (DataFrames)

temperature_model_min = 270 # create pretty graphs
temperature_model_max = 350
delta_temperature_model = temperature_model_max - temperature_model_min
temperature_model_x_axis = [temperature_model_min,temperature_model_max]
