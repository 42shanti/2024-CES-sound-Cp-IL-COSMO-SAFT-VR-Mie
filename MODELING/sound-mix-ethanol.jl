print(@__FILE__)
print("\n")
# sound evaluation mixture ethanol
# bs04
...
# INPUT
    ...
    species = "C6MIMTF2N"
    cute_species = "IL: [C₆mim][Tf₂N]"

# EXPERIMENTAL PATH
    full_file_path_x = ["C:/Users/bc_usp/My Drive (cleitonberaldo@usp.br)/usp-brainstorm/bs04/csv/binary-sound/x-eC6MIMTF2N.csv"] # composition file
    full_file_path_sound = ["C:/Users/bc_usp/My Drive (cleitonberaldo@usp.br)/usp-brainstorm/bs04/csv/binary-sound/y-eC6MIMTF2N.csv"] # sound file
...
# ORGANIZE BOUNDARIES
    x_interval = (min_exp_x:0.01:max_exp_x)
#
...
# INPUT MODEL
    ...
    species_solute = "ethanol_3B"
    species_NA = "C6MIMTF2N_NA"
    species_2B = "C6MIMTF2N_2B"
    species_4C = "C6MIMTF2N"
